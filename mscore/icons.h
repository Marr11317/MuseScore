...
enum class Icons : signed char { Invalid_ICON = -1,
      ...
      flip_ICON, plus_ICON, minus_ICON, equal_ICON,
      undo_ICON, redo_ICON, cut_ICON, copy_ICON, paste_ICON, swap_ICON, print_ICON, clef_ICON,
      midiin_ICON, speaker_ICON, start_ICON, play_ICON, stop_ICON, repeat_ICON, pan_ICON,
      sbeam_ICON, mbeam_ICON, nbeam_ICON, beam32_ICON, beam64_ICON, abeam_ICON, fbeam1_ICON, fbeam2_ICON,
      file_ICON, fileClose_ICON, fileOpen_ICON, fileNew_ICON, fileSave_ICON, fileSaveAs_ICON,
      ...
      parentheses_ICON, brackets_ICON, plugins_ICON,
      ...
      edit_ICON, reset_ICON, close_ICON,
