...
class PluginAPI : public Ms::QmlPlugin {
   ...
   signals:
       ...
       *    changes will trigger this signal again after calling Score::endCmd()
       *
       * \param score The score that was saved.
       * \param ext The extension with wich the score was saved.
       * Example:
       * \code
       *import QtQuick 2.0
       *import MuseScore 3.0
       ...
       * \since MuseScore 3.5
       */
      void scoreSaved(Score* score, const QString& ext);
...
public slots:
      ...
      void sendScoreSaved(Ms::Score* s, const QString& ext) override; // WARNING: Ms::Score is not the same as Ms::PluginAPI::Score!
